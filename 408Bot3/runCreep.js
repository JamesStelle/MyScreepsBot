...
//var roleCarrierTower = safeRequire('role.carrierTower');
var roleCarrierMineral = safeRequire('role.carrierMineral');
var roleCarriermachine = safeRequire('role.carriermachine');
...
var roleAttackController = safeRequire('role.attackController');
var roleReserver = safeRequire('role.reserver');
var roleBuildermachine = safeRequire('role.buildermachine');
var roleUpgradermachine = safeRequire('role.upgradermachine');
var roleDefendermachine = safeRequire('role.defendermachine');
...
//if (roleCarrierTower) roleFunc.carrierTower = roleCarrierTower;
if (roleCarriermachine) roleFunc.carriermachine = roleCarriermachine;
...
if (roleAttackController) roleFunc.attackController = roleAttackController;
if (roleReserver) roleFunc.reserver = roleReserver;
...
if (roleDefendermachine) roleFunc.defendermachine = roleDefendermachine;
